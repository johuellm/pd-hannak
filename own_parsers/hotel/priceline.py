...
class PricelineParser(HotelParser):

	def __init__(self, html_file):
		super(self.__class__, self).__init__(html_file)
		#self.hotel_name_selector = '.blue2-10.retail-listing.group .left.group.ht-content .group .left.ht-details.check-rates-ht-details h3 a'
		self.hotel_name_selector = '.listitem .listitem_left_group .listitem_left_top_group .listitem_name .listitem_name_link'
                #self.price_selector = '.blue2-10.retail-listing.group .left.group.ht-content .price-container.right .price a'
		self.price_selector = '.listitem .listitem_right_group .listitem_price .listitem_price_amount' #.listitem_price_group 
